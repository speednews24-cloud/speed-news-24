...
import { analytics, createAd, listAds, refreshArticles, triggerAggregation, updateAd } from '../controllers/admin.controller.js';
...
router.post('/refresh-articles', refreshArticles);
