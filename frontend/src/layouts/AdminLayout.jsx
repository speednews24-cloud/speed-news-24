...
import { BadgeIndianRupee, Home, LayoutDashboard, Newspaper, Tags } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-100 dark:bg-brand-black">
      <aside className="fixed inset-y-0 left-0 hidden w-64 border-r border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-950 md:block">
        ...
        <nav className="grid gap-2">
          <Link to="/" className="btn-primary justify-start"><Home size={18} />View Site</Link>
      ...
      <main className="p-4 md:ml-64 md:p-8">
        <div className="mb-4 flex justify-end md:hidden">
          <Link to="/" className="btn-primary"><Home size={18} />View Site</Link>
        </div>
        <Outlet />
      </main>
    </div>
